    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Restaurant Info */}
          <div>
            <h3 className="text-xl font-semibold mb-4">Food 'n' Fun</h3>
            <p className="text-gray-300 mb-4">
              Your go-to destination in Tanuku for delicious, freshly prepared meals 
              that bring families, friends, and food lovers together.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2 text-gray-300">
                ...
                <span className="text-sm">foodnfun.tnk@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300">
                <Instagram className="h-4 w-4" />
                <span className="text-sm">@foodnfun.tnk</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2024 Food 'n' Fun. All rights reserved. | Made with ❤️ in Tanuku
          </p>
        </div>
      </div>
    </footer>
