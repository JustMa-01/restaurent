  ...
  const contactInfo = [
    {
      ...
      title: "Visit Us",
      details: [
        "Sri Chaitanya School, Backside to,",
    ...
    },
    {
      ...
      title: "Email Us",
      details: ["foodnfun.tnk@gmail.com"],
      action: "Send Email"
    },
    {
      icon: <Instagram className="h-6 w-6" />,
      title: "Follow Us",
      details: ["@foodnfun.tnk"],
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Multiple ways to reach Food 'n' Fun</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-center"
              >
            ...
            >
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-3xl font-bold text-orange-600 mb-2">11:30 AM – 11:30 PM</div>
              ...
              <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-8">
                <div className="space-y-6">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 rounded-lg font-semibold flex items-center justify-center space-x-2 hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
