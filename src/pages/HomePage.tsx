  ...
  const features = [
    {
      ...
      description: "Authentic North and South Indian dishes made with fresh ingredients"
    },
    {
    ...
    <div className="min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-4 opacity-90">
              Delicious Meals, Quick Service, Great Vibes
            </p>
            <p className="text-lg mb-8 opacity-80 max-w-2xl mx-auto">
              Your go-to destination in Tanuku for authentic North & South Indian cuisine
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/customer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-white text-orange-600 px-8 py-4 rounded-full text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300"
                >
                  Order Now 🚀
                </motion.button>
              </Link>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Food 'n' Fun?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're committed to bringing you the best dining experience in Tanuku with quality food, quick service, and a warm atmosphere.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="text-center p-6 rounded-2xl bg-gradient-to-br from-orange-50 to-red-50 hover:shadow-lg transition-all duration-300"
              >
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">foodnfun.tnk@gmail.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <Link to="/customer">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    Start Ordering 🍽️
                  </motion.button>
                </Link>
