...
export function AboutPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-orange-600 via-red-500 to-pink-600 text-white py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
              Where passion for food meets the heart of Tanuku community
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Welcome to Food 'n' Fun</h2>
              <div className="prose prose-lg text-gray-700 space-y-4">
                <p>
                  Welcome to <span className="font-semibold text-orange-600">Food 'n' Fun</span>, your go-to destination in Tanuku for delicious, freshly prepared meals that bring families, friends, and food lovers together.
                </p>
                <p>
                  We serve a variety of North and South Indian dishes with quick service and student-friendly pricing. Our mission is simple: to create a cozy, flavorful experience that makes every meal memorable.
                </p>
                <p>
                  Located in the heart of IKEA Nagar, near Sri Chaitanya School, we've become a beloved gathering place for the local community. Whether you're a student looking for a quick bite, a family celebrating a special occasion, or friends catching up over delicious food, Food 'n' Fun is your perfect destination.
                </p>
                <p>
                  Come visit us and discover why we're quickly becoming Tanuku's favorite dining spot!
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-orange-400 to-red-500 rounded-2xl shadow-2xl p-8 text-white">
                <div className="text-center">
                  <ChefHat className="h-16 w-16 mx-auto mb-4" />
                  <h3 className="text-2xl font-bold mb-4">Our Kitchen Philosophy</h3>
                  <p className="text-lg opacity-90">
                    "Every dish is prepared with love, fresh ingredients, and traditional recipes passed down through generations."
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The principles that guide everything we do at Food 'n' Fun
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-4xl font-bold mb-4">Food 'n' Fun by the Numbers</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="mt-8 p-4 bg-gradient-to-r from-orange-100 to-red-100 rounded-xl"
              >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-gradient-to-br from-orange-400 to-red-500 rounded-2xl shadow-2xl p-8 text-white text-center"
            >
